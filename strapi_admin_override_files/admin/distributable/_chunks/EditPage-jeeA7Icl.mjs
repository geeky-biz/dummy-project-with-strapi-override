...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-9D8SuHYl.mjs";
...
import { u as useWebhooks } from "./useWebhooks-rSEDxAuT.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-ObXOx89U.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-jeeA7Icl.mjs.map
