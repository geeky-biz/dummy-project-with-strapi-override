...
const useWebhooks = require("./useWebhooks-HHH0cKE7.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-N-R7BrQb.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-Ya1LueW9.js.map
